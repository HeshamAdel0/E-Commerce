    ...
    */
    ...
    if (isset($_SESSION['Username'])) {
        ...
        if ($do == 'Manage') { //- Manage page
         ...
         // Select All Users Except Admin 
			...
			$stmt = $con->prepare("SELECT 
                                        comments.*, item.Name AS Item_Name, users.Username AS Member  
                                    FROM 
                                        comments
                                    INNER JOIN 
                                        item 
                                ...
                                foreach($comments as $comment) {
                                    echo "<tr>";
                                        ...
                                        echo "<td>
                                            ...
                                            if ($comment['Status'] == 0) {
                                                 echo "<a href='comment.php?do=Approve&comid=" . $comment['c_ID'] . "' class='btn btn-info activate'><i class='fa fa-check'></i> Approve </a>";  
                                            }
                                        echo "</td>";
                                    echo "</tr>";
                                }
      ...
      <?php
            ...
            // Check If Get Request comment id Is Numeric & Get Its Integer Value
